...
def simulate(model_path, scen_file_pth, shield_type, lacam_lookahead, args):
    """Inputs:
...
def main(args: argparse.ArgumentParser):
    ...
    starttime = time.time()
    solution_path, total_cost_true, total_cost_not_resting_at_goal, num_agents_at_goal, success = simulate(
            args.model, args.scen_to_run, args.shieldType, args.lacamLookahead, args)
    endtime = time.time()
    ...
    with open(args.outputCSVFile, 'a') as f:
        ...
        writer.writerow([args.mapName, args.scenFile, args.agentNum, args.seed, args.shieldType, args.lacamLookahead,
                         ...
                         success, total_cost_true,  num_agents_at_goal, runtime])
