...
from eph_mapf.src.environment import Environment
from eph_mapf.src.utils.utils import timeout
...
def test_one_case(
    ...
    # print("step",step,"\n")
    # print("num_comm",num_comm,"\n")
    # print("arrived",arrived_num,"\n")
    # print("agent_pos",agent_positions,"\n")
...
def test_model(checkpoint_name: Union[int, str], config=config):
    ...
    """
    config.ensemble = [(False, None, None, False,None),]
    with torch.inference_mode():
        print(config.model_target)
